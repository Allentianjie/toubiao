        ...
        <Row style="height:100%">
            ...
            <Col span="19">
                <div class="M_search">
                    ...
                    <!--<i-button type="primary" @click="showUserRoles({current: 1, pageSize: 10}, selectionArr[0], true, true)">用户角色-->
                    <!--</i-button>-->
                ...
                <div class="button-group">
                    <Row style="height:100%" type="flex" justify="start">
                        <el-button icon="el-icon-plus" @click="EditData('add')" type="primary" size="small">添加
                        </el-button>
                        <i-button type="primary"
                                  @click="showUserRoles({current: 1, pageSize: 10}, selectionArr[0], true, true)">
                            用户角色
                        </i-button>
                        <i-button type="primary" @click="showUserManageDepartMent(selectionArr[0])">管辖部门</i-button>
                        <i-button type="error" @click="resetPwd(selectionArr[0])">密码重置</i-button>
                ...
                <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
                    ...
                    <FormItem label="类型" prop="type">
                        ...
                        <Select disabled v-model="formValidate.type" placeholder="请选择类型">
                            <Option v-for="item in options.roleDatas" :value="item.value" :key="item.value">{{
                                item.label }}
                            </Option>
                        </Select>
                    </FormItem>
        ...
        <div>
            ...
            <Modal v-model="showUserDepartmentModel" class-name="editUserModal" width="50"
                ...
                <div class="userTree">
                    ...
                    <el-tree :data="userManageDepartTree" :props="defaultProps" show-checkbox highlight-current
                             check-strictly
            ...
            <Modal v-model="showUserRoleModel" class-name="editUserModal" width="50"
                ...
                <div class="userTree">
                    ...
                    <div class="M_search">
                        ...
                        <el-button icon="el-icon-search" @click="searchroles" type="primary" size="small">搜 索
                        </el-button>
                        <el-button icon="el-icon-delete" @click="clearqueryrole" size="small">清 空</el-button>
                    </div>
                    <div class="table">
                        <Table :tableData="userRoleData" ref="userRoleTable" @ftablePage="fTablePage2"
                               @frowchecked="frolechecked"
...
//        console.log(666, data)
            ...
            EditData(type, params) {
                ...
                if (type === 'edit') {
                    ...
                    this.formValidate.type = this.options.roleDatas[3].value;
