    ...
    methods:{
      clickBar(obj){
        if(obj.type ==='seriseId'){
          ...
          this.$router.push({path: '/studentTwoChart', query: {parame: parame}})
        }
      ...
      getData(type){
        ...
        if(type === 'One') {
          ...
          that.$Get("/admin/teachDrilling/getStudenPeopleSeriseMapList", obj, function (data) {
          ...
          that.$Get("/admin/teachDrilling/getStudenPeopleMajorMapList", obj, function (data) {
