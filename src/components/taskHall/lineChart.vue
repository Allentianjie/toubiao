<template>
  <div id="queryEchartsM" style="width:100%;height:100%">
...
<script>
  ...
  export default {
    ...
    methods: {
      pieChart() {
        let {pieChartId,seriesData} = this.lineChartData;
        let doc = document.querySelector('#queryEchartsM')
        doc.innerHTML = `<div style="width: 100%;height:300px;">暂无55数据</div>`
        this.$nextTick(() => {
