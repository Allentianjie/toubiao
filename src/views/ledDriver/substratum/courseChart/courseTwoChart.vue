  ...
  export default {
    ...
    methods:{
      ...
      getTopOne(str){
        ...
        that.$Get("/admin/subDrillCourse/getCourseSumSeriseAttendanceRate", obj, function (data) {
          data.data.forEach(e => {
            e.count = (e.count * 100).toFixed(2)
          })
          that.getBarData(data.data,'three',str.symbol)
      ...
      getTopTwo(str){
        ...
        that.$Get("/admin/subDrillCourse/getCourseSumSeriseClassAcivity", obj, function (data) {
          data.data.forEach(e => {
            e.count = (e.count * 100).toFixed(2)
          })
      ...
      getTopThree(str){
        ...
        that.$Get("/admin/subDrillCourse/getCourseSumSeriseHomeWorkFinish", obj, function (data) {
          data.data.forEach(e => {
            e.count = (e.count * 100).toFixed(2)
          })
          // console.log(11,data.data)
      ...
      getData(data){
        ...
        that.$Get("/admin/subDrillCourse/getCourseSumSeriseListByParentId", obj, function (data) {
          // console.log(22,data.data)
          that.getBarData(data.data,'three')
          that.getLineData(data.data)
        })
      },
      // 柱状图
      getBarData(data,type,symbol){
        ...
        that.barChartData = {
          id: "barChar",
          backData: data, // 传入返回参数，需要参数的 isTeach 判断下钻路线
          seriesData: {
            xData: xDataBar,
            yData: yDataBar,
            id: idBar,
