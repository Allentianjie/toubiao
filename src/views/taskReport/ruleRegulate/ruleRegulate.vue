              ...
              <el-table
                ...
                <el-table-column prop="action" key="3" align="center" label="关联文件">
                  <template slot-scope="scope">
                    <el-button size="small" style="color: #3A8EE6" plain
                               @click="fileClick(scope.row,scope.row.targetFiles,scope.row.standardFiles)">支撑文件
                    </el-button>
                  </template>
                </el-table-column>
              </el-table>
    ...
    methods: {
      ...
      gettableData() {
        ...
        that.$Get(
          ...
          Object.assign(that.page, that.search, {fileType: 31, deptId: that.deptId}),
          function (data) {
...
<style lang='less' scoped>
  @import url("../obligation/obligation.less");
