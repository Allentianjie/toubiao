<template>
  <div id="queryEchartMs" style="width:100%;height:80%" :class="nodata">
    <div style="width:100%;height:100%" :id="lineChartData.id"></div>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      pieChart() {
        ...
        let doc = document.querySelector("#queryEchartMs");
