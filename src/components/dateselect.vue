    ...
    methods: {
      ...
      emitDate() {
        ...
        if ( this.currentDate.year && this.currentDate.month && this.currentDate.day) {
          ...
          dateStr = this.currentDate.year + "-" + month + "-" + day;
        }else if(this.currentDate.year && this.currentDate.month){
          let month = this.currentDate.month < 10 ? ('0'+ this.currentDate.month):this.currentDate.month;
          dateStr = this.currentDate.year + "-" + month;
        } else if(this.currentDate.year){
          dateStr = this.currentDate.year;
        }else {
          dateStr = "";
        }
