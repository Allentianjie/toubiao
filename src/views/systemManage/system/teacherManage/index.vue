    ...
    <Row style="height:100%">
      ...
      <Col span="19">
        <div class="M_search">
          ...
          <el-button class="funaddBtn" icon="el-icon-plus" @click="EditData('add')" type="primary" size="small">添加
          </el-button>
        </div>
      ...
      <Modal v-model="showModel" class-name="editUserModal" width="30"
        ...
        <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
          ...
          <FormItem label="部门" prop="deptName">
            <Col span="20"><Input disabled v-model="formValidate.deptName"></Input></Col>
            <Col span="4">
    ...
    methods: {
      ...
      EditData(type, params) {
        ...
        if (type === 'edit') {
          ...
          this.formValidate.type = this.options.roleDatas[1].value;
