  ...
  <div class="userManage">
    ...
    <Row style="height:100%">
      <Col span="5"  style="height:100%">
        ...
        <div class="userTree">
          <Tree  id='taskTreeL' :baseData="baseData" ref="deptTree" @fSelectTreeData="selectDeptTree" :showBox="false"></Tree>
        </div>
      </Col>
      <Col span="19">
        <div class="M_search">
      ...
      <Modal v-model="showModel" class-name="editUserModal" width="50"
        ...
        <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
          ...
          <FormItem label="部门" prop="deptName">
            <Input disabled v-model="formValidate.deptName"></Input>
            <Button @click="changeUserDept"><Icon type="md-reorder" /></Button>
          </FormItem>
    ...
    <div>
      ...
      <Modal v-model="showUserDepartmentModel" class-name="editUserModal" width="50"
        ...
        <div class="userTree">
          ...
          <el-tree :data="userManageDepartTree" :props="defaultProps" show-checkbox highlight-current check-strictly :filter-node-method="filterNode"
                   :default-checked-keys="defaultDeptCheckedKeys" :default-expanded-keys="[1]"  node-key="id" @check="handleNodeClick" ref="tree"></el-tree>
        </div>
        <div slot="footer">
    ...
    <div>
      <Modal v-model="showUserRoleModel" class-name="editUserModal" width="50"
        ...
        <div class="userTree">
          ...
          <div class="table">
            <Table :tableData="userRoleData" ref="userRoleTable" @ftablePage="fTablePage2" @frowchecked="frolechecked" @frowunchecked="froleunchecked"></Table>
          </div>
    ...
    <ChooseDepartMent ref="chooseDepartmentModal" :choiceDept="chooseDepartment"  @closeSelectTreeMain="closeChoiceDeptModal"></ChooseDepartMent>
    ...
    created() {
      ...
      // });
       let data=store.state.chooseDept
        var m = NeizhenUtil.treeDataToStandardTreeData(data, {"id" : "id", "name" : "name", "pid" : "parentId", "children" : "children" });
    ...
    methods: {
      ...
      searchusers() {
        this.refreshUserData(this.initpage.current,
                             this.initpage.size,
                             this.deptTreeSelect.length > 0 ? this.deptTreeSelect.extdata.id : null,
                             this.searchName.username,
                             this.searchName.name);
      ...
      getSelectedDept () {
        if (this.deptTreeSelect.length > 0) {
          return {id : this.deptTreeSelect.extdata.id,
                  name : this.deptTreeSelect.extdata.name,
      ...
      EditData (type, params) {
        ...
        if(type === 'edit') {
          ...
          this.formValidate.deptName = this.deptTreeSelect.extdata.name;
          this.formValidate.deptId = this.deptTreeSelect.extdata.id;
      ...
      fTablePage (pageData) { // 分页
        ...
        if (this.deptTreeSelect!= null) {
          deptId = this.deptTreeSelect.extdata.id;
        }
