    ...
    <header id="heardBox" class="heardBox">
      ...
      <div v-show="!Switch" class="my_nav">
        <div class="collapse-btn">
          <i v-if="collapses" @click="collapseChage" class="el-icon-d-arrow-left" style="cursor: pointer"></i>
          <i v-else @click="collapseChage" class="el-icon-d-arrow-right" style="cursor: pointer"></i>
        </div>
        <div class="nav-title">
          诊断与改进平台
        </div>
