    ...
    methods: {
      ...
      handleSubmit() {
        ...
        if (this.operation == "add") {
          ...
          // 保存文件信息
          this.$Post("/admin/chunkfile/saveAndReturnValue", {
            ...
            if (data.code==0) {
              ...
              let obj = data.data;
              that.$emit("closeMains", obj);
            }
          });
              // let obj = {fileId:967,fileName:"demo5",filePath:"mfile-1",fileSize: 137098,fileSoruce:null,fileSuffix:"pdf",fileType:"31"};
              // that.$emit("closeMains", obj);
        } else {
