<template>
  <div id="preView" style="width:100%">
    <Modal id="preViewBox" class-name="vertical-center-modal" v-model="assignDetailData.state" width="50%"
           :mask-closable="false"
           @on-cancel="closeAssignmentModal3"
    >
      ...
      <Form :label-width="100">
        <div class="fileManage">
              ...
              >
                <Row>
                  ...
                  <!--<Col span="3" style=" text-align: right">-->
                    <!--<Icon-->
                      <!--@click="removeAllocateTaskItem(taskForm,taskIndex)"-->
                      <!--class="removeItem"-->
                      <!--v-if="taskForm.unEndTask"-->
          ...
          <!--<div class="addItem">-->
            <!--<Icon @click="additem" type="md-add-circle" style="font-size:30px"/>-->
          <!--</div>-->
        </div>
      </Form>
      ...
      <div slot="footer" style="text-align: center">
        ...
        <Button type="warning" size="large" @click="closeAssignmentModal3('targetForm')">关闭</Button>
      </div>
    </Modal>
  </div>
</template>
  ...
  export default {
    ...
    computed: {
      hierarchyName: function () {
        let task = this.assignDetailData.data;
        return (
          task.hieName +
          " / " +
          task.levelName +
    ...
    methods: {
      ...
      changeDeptdata(index, val) {
        ...
        this.options4 = [];
        if (val != undefined) {
          this.$Get('admin/database/getByIdentIdAndDeptId?identId=' + this.assignDetailData.identId + '&deptId=' + val, null, (res) => {
            if (res.data != null) {
              ...
              this.targetForm[this.itemIndex].dataName=deptName+this.addTaskData.data.taskName;
              this.targetForm[this.itemIndex].taskName=deptName+this.addTaskData.data.taskName
            }
          })
        }
      ...
      searchData() {
        this.options4 = [];
        let params = {
          deptId: this.assignDetailData.deptId,
          parentId: this.assignDetailData.dataId,
          dataName: this.targetForm[this.itemIndex].dataName, // 名称
          layType: this.assignDetailData.hieId
        };
        fetchValueLists(
          Object.assign(
            {
      ...
      //获取部门
      getDeptData() {
        this.$Get("/admin/dept/getByPid?parentId=" + this.assignDetailData.data.deptId, null, res => {
        ...
        if (allocateTasks.length > 0) {
          ...
          allocateTasks.forEach(task => {
            ...
            this.targetForm.push({
              deptId: (this.assignDetailData.deptId).toString(),
              dataId: task.dataId,
              dataType: (this.assignDetailData.data.dataType).toString(),
              taskId: task.taskId,
            ...
            this.$Modal.confirm({
              ...
              onOk: () => {
                ...
                let formData = {
                  ...
                  dataId: form.dataId,
                  parentId: that.assignDetailData.data.taskId,
                ...
                if (that.addDataState == false) {
                  ...
                  if (Number.isInteger(taskId)) {
                    ...
                    if(that.openIndex==1){
                      that.$Put("/admin/task", param, function (data) {
                        ...
                        that.$emit("closeAssignmentModal3", {
                          state: false,
                        });
                      });
                  ...
                  let params = {
                    ...
                    parentId: that.assignDetailData.dataId,
      ...
      additem() {
        if (this.noData == false) {
          ...
          this.changeVlue(this.assignDetailData.data.dataType);
          this.targetForm.push({
            deptId: "",
            dataType: (this.assignDetailData.data.dataType).toString(),
            taskName: "",
            ...
            dataName: "",
            dataId: this.assignDetailData.data.dataId,
            targetStrategy: this.assignDetailData.data.targetStrategy,
            targetValue: this.assignDetailData.data.targetValue,
            standardStrategy: this.assignDetailData.data.standardStrategy,
            standardValue:this.assignDetailData.data.standardValue,
            standardWeight: this.assignDetailData.data.standardWeight,
            targetWeight: this.assignDetailData.data.targetWeight,
            warnStrategy: this.assignDetailData.data.warnStrategy,
            warnValue: this.assignDetailData.data.warnValue,
            disValue: this.assignDetailData.data.disValue,
            dataValue: this.assignDetailData.data.dataValue,
            directorVos: [],
            targetFileVos: [],
            unEndTask: true,
            updateModal: false
      ...
      changeVlue(val) {
        //编辑
        if (val == '2') {
          this.assignDetailData.data.targetValue = (this.assignDetailData.data.targetValue * 100).toFixed(2);
          this.assignDetailData.data.warnValue = (this.assignDetailData.data.warnValue * 100).toFixed(2);
          this.assignDetailData.data.standardValue = (this.assignDetailData.data.standardValue * 100).toFixed(2);
        } else if (val == '3') {
          this.assignDetailData.data.targetValue = (this.assignDetailData.data.targetValue * 1000).toFixed(2);
          this.assignDetailData.data.warnValue = (this.assignDetailData.data.warnValue * 1000).toFixed(2);
          this.assignDetailData.data.standardValue = (this.assignDetailData.data.standardValue * 1000).toFixed(2);
        }
      ...
      openBasicData(row, ind) {
        this.basicData.identId = this.assignDetailData.identId; //最外层传的id
      ...
      closeAssignmentModal3() {
        this.$emit("closeAssignmentModal3", {
          state: false,
        });
      },
      //获取策略符号
