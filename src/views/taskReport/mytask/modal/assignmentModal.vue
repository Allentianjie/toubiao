    ...
    methods: {
      ...
      changeVlue(val) {
        ...
        if (val == '2') {
          ...
          this.assignmentData.data.standardValue = (this.assignmentData.data.standardValue * 100).toFixed(2);
        } else if (val == '3') {
          ...
          this.assignmentData.data.standardValue = (this.assignmentData.data.standardValue * 1000).toFixed(2);
        }
