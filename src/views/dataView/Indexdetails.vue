    ...
    <div id="flowPage" ref="flowPage">
        ...
        <div class="taskSummaryItem">
            <el-row>
                ...
                <el-col :span="20" ref="NineHeight" id="rightHeight" style=" padding-top: 0;">
        ...
        <indicatorModal class="theme" ref="indicatorModal" :normData="normData" @closeNormModal="closeNormModal"></indicatorModal>
        <taskdetailModal
            ref="assignModal"
...
import taskdetailModal from "./modal/taskdetailModal"; //引入支撑文件管理Modal
import TrackModal from "./modal/TrackModal.vue"; //引入支撑文件管理Modal
import evdenceModal from "@/components/evdenceModal";
export default {
    name: "index",
    components: { deptModal, indicatorModal, taskdetailModal, TrackModal,evdenceModal},
    data() {
        return {
          evidenceData:{
            data:"",
    ...
    mounted() {
        ...
        this.$nextTick(() => {
          ...
          this.tableHeight ="height:" +
            (this.$refs.flowPage.clientHeight - 230) +
            "px";
        });
    ...
    methods: {
      ...
      returnSuperior(){
        ...
        if(this.superior.length > 1){
          console.log(555,this.superior.length)
